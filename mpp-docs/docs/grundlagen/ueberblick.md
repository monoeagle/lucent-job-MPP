...
MPP laeuft im Lucent Hub Oekosystem. Backend auf Port **5000**, Frontend auf Port **3000**, Dokumentation auf Port **5083**. Start ueber `scripts/mpp.sh` (interaktiver Dev-Launcher).
